  ...
  <div class="row">
   ...
   {{-- error report  start--}}
      ...
      {{-- end error report --}}
        ...
        <!--  <a  href="{{URL::to('/')}}/Sales/addsales" class="btn btn-icon icon-left btn-info" style=" width: 110px !important; "><i class="fa fa-edit"></i> New Sales</a>-->
        <!--  </div> <br/>-->
            ...
            <table class="table table-striped" id="table-1">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td> <a href="{{URL::to('/')}}/Sales/editSales/{{$key->id}}" class="btn btn-sm btn-info" style=" width: 90px !important; ">EDIT SALE</a>
                   <a href="{{URL::to('/')}}/Sales/editSold/{{$key->id}}" class="btn btn-sm btn-success" style=" width: 90px !important; ">EDIT SOLD</a>
                    </td>
                </tr>

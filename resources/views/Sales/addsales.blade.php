...
@section('content')              
 ...
 {{-- error report --}}
  ...
  <form action="{{URL::to('/')}}/Sales/storesales" method="post" class="needs-validation"  enctype="multipart/form-data">
    {{ csrf_field() }}      
      <div class="form-row">
      ...
      <div class="form-group col-md-6">
        ...
        <select  name="sale_action" class="form-control"  required="">
      ...
      <div required="" class="form-group col-md-6">
        ...
        <select name="warranty" id="war" class="form-control" >
          <option value="NO">NO</option>
        <option value="YES" >YES</option>
    ...
    <div class="card-footer">
      ...
      <a href="{{URL::to('/')}}/Sales/sales" class="btn btn-warning" >Cancle</a>
    </div>
  </div>
